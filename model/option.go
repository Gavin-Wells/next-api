...
func InitOptionMap() {
	...
	common.OptionMap["ParamRatioConfig"] = ratio_setting.ParamRatioConfig2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ParamRatioConfig":
		err = ratio_setting.UpdateParamRatioConfigByJSONString(value)
	case "TopUpLink":
